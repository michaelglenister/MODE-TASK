...
def main(args):
	...
	interfaceIndex = []
	f = open(args.protomer_pdb,'r')# The pdb file on which NMA analysis was performed, this script handles on model at a time but we can change this 
	NMA = f.readlines()
	f.close()
	count =0
	for line in NMA:
	...
	fw = open(args.wmatrix,'r') # '3VBSProtomerW.txt' #W matrix input file that was output from C++ Scripts
...
if __name__ == "__main__":
    ...
    parser.add_argument("--protomer_pdb", help="input")  # '3VBSProtomer.pdb'
